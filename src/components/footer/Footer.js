  ...
  return (
    <footer className="footer">
      <nav className="footer__nav">
        ...
        <a href="./pages/bookmarks.html" className="footer__link">
          <svg
            className="footer__icon"
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
        ...
        <a href="./pages/create-question.html" className="footer__link">
          <svg
            className="footer__icon"
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
        ...
        <a href="./pages/user.html" className="footer__link">
          <svg
            className="footer__icon bi bi-person-fill"
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
            viewBox="0 0 16 16"
